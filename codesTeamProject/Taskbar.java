...
public class Taskbar extends JPanel implements MouseListener {
	...
	public static TransformGroup taskboard() {
		...
		tg.addChild(frame(verts,CommonsEK.Grey));
		Point3f pos = new Point3f(-20f,8f,0f);
		tg.addChild(txt("Clues to Escape the Room",0.2f,CommonsEK.White,pos));
		Point3f pos1 = new Point3f(-19.5f,6f,0f);
		tg.addChild(txt1("• Find and complete",0.2f,CommonsEK.White,pos1));
		Point3f pos2 = new Point3f(-19.5f,5f,0f);
		tg.addChild(txt1("  the cube puzzle",0.2f,CommonsEK.White,pos2));
		Point3f pos3 = new Point3f(-19.5f,4f,0f);
		tg.addChild(txt1("• Find and complete",0.2f,CommonsEK.White,pos3));
		Point3f pos4 = new Point3f(-19.5f,3f,0f);
		tg.addChild(txt1("  the Dial Puzzle",0.2f,CommonsEK.White,pos4));
		Point3f pos5 = new Point3f(-19.5f,2f,0f);
		tg.addChild(txt1("• Find the painting of a",0.2f,CommonsEK.White,pos5));
		Point3f pos6 = new Point3f(-19.5f,1f,0f);
		tg.addChild(txt1("  spacex rocket",0.2f,CommonsEK.White,pos6));
		/*
	...
	public Taskbar(BranchGroup sceneBG) {
		...
		CommonsEK.setEye(new Point3d(0, 0, 10.0));
